...
{
    [Authorize]
    public partial class AccountController : ShaneSpotAbstractController
    {
        public AccountController()
        {
            UserManager = new UserManager<ApplicationUser>(new UserStore<ApplicationUser>(() => RavenSession));
        }
        ...
        public virtual ActionResult ManageProfile(ManageProfileViewModel model)
        {
            // save changes to database
            string userId = User.Identity.GetUserId();
            var user = RavenSession.Load<ApplicationUser>(userId);
        ...
        public virtual async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    model.ProfilePictureUrl = "http://rymaec.org/sites/all/themes/rymaec/img/no_photo.jpg";
                }
        ...
        public virtual ActionResult Manage(ManageMessageId? message)
        {
            ViewBag.StatusMessage =
                ...
                : message == ManageMessageId.UpdateProfileSuccess ? "Your user profile has been updated."
                : message == ManageMessageId.Error ? "An error has occurred."
                : "";
            ViewBag.HasLocalPassword = HasPassword();
            ViewBag.ReturnUrl = Url.Action("Manage");
            UserHelper helper = new UserHelper(RavenSession);
            ViewData["ManageProfileViewModel"] = helper.GetApplicationUser(User.Identity).ToManageProfileViewModel();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public virtual async Task<ActionResult> Manage(ManageUserPasswordViewModel model)
        {
